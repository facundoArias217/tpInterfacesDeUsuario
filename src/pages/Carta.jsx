    ...
    return (
        <Container className="my-4" fluid>
            <Row className="justify-content-lg-center">
                {menu.map(p => <Col key={p.id} className="d-flex justify-content-center customStyle" xs={12} md={4} sm={6} lg={4} xl={2}>{<Producto producto={p} textoBoton='Añadir al Carrito' accion={accionBoton} />}</Col>)}
            </Row>
        </Container>
    )
};
